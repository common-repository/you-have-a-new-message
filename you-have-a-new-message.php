...
Plugin URI: https://wordpress.org/plugins/you-have-a-new-message/
...
add_action( 'widgets_init', 'yhanm_register_widget' );
function yhanm_register_widget() {
	register_widget( 'YouHaveANewBuddyPressMessageWidget' );
}
